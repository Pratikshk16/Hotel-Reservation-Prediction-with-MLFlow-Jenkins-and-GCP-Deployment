...
class DataProcessor:
    ...
    def select_features(self, df):
        try:
            logger.info("Starting feature selction step.")
            X = df.drop(columns = 'booking_status')
            y = df['booking_status']
            ...
            logger.info(f"Top {num_features_to_select} features are: {top_10_features}")
    ...
    def save_data(self, df, file_path):
        try:
            ...
            logger.error(f"Error saving data at {file_path} : {e}")
